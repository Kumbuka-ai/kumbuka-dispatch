...
import ai.kumbuka.dispatch.fixture.UnboundReadFixture;
 ...
 * a lookup method concludes. This was measured in the sibling service while
 * its item domain was being built: a registry lookup raised
 ...
 * caller should declare it first. The mechanism carries over unchanged,
 * because the tenancy aspect the two services run under is the same set of
 * classes. A typed refusal naming the wrong cause is
